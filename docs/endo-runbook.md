...
Download the wizard (`setupwizzard`) for your laptop from the
[OpenTollGate/setupwizzard releases](https://github.com/OpenTollGate/setupwizzard/releases/latest):

- **macOS (Intel)**: `setupwizzard-darwin-amd64`
- **macOS (Apple Silicon M1/M2/M3)**: `setupwizzard-darwin-arm64`
- **Windows**: `setupwizzard-windows-amd64.exe`
- **Linux**: `setupwizzard-linux-amd64`
...
```bash
chmod +x setupwizzard-darwin-*
./setupwizzard-darwin-amd64    # Intel Mac
./setupwizzard-darwin-arm64    # Apple Silicon Mac
```

**Windows:** Double-click `setupwizzard-windows-amd64.exe`

**Linux:**
```bash
chmod +x setupwizzard-linux-amd64
./setupwizzard-linux-amd64
```
